    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-center justify-between gap-3 pt-1">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3.5 py-2 rounded-2xl liquid-glass hover:bg-white/80 dark:hover:bg-slate-800 text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200 border border-slate-200/60 dark:border-white/10 transition shadow-xs active:scale-95"
